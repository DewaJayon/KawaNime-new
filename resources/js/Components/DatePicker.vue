...
<template>
    <Popover>
        <PopoverTrigger as-child>
            <Button
                variant="outline"
                class="w-full justify-start text-left font-normal bg-transparent hover:bg-transparent border-slate-700 h-11 py-3"
            >
        ...
        <PopoverContent :class="dropdownClass" class="w-[300px] p-4 space-y-2">
            ...
            <div class="flex gap-2">
                <select
                    ...
                    class="w-1/2 rounded border px-2 py-1 text-sm bg-slate-800 text-white"
                >
                    <option
                ...
                <select
                    v-model="currentYear"
                    class="w-1/2 rounded border px-2 py-1 text-sm bg-slate-800 text-white custom-scrollbar"
                >
            ...
            <div class="grid grid-cols-7 text-center text-sm">
                <div
                    ...
                    class="py-1.5 cursor-pointer rounded hover:bg-primary"
                    :class="{
                        'bg-primary text-white': isSameDay(day, selectedDate),
