...
const thumbnail = ref(props.row.thumbnail);

const form = useForm({
    title: props.row.title,
    studio: props.row.studio,
...
watch(thumbnail, (newValue) => {
    ...
    form.thumbnail = newValue;
});

// Buat state lokal untuk sinkronisasi dua arah
...
const submit = () => {
    ...
    router.post(
        route("dashboard.anime.update", props.row.slug),
        {
            _method: "put",
            ...form,
        },
...
<template>
    <Dialog v-model:open="dialogOpen">
        ...
        >
            <DialogHeader>
                <DialogTitle class="text-white">Edit Anime</DialogTitle>
            ...
            >
                ...
                <div class="md:col-span-2">
                    ...
                    <DropzoneImage v-model="thumbnail" />
